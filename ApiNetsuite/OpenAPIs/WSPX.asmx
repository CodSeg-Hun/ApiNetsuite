...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/API_PX/WSPX.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">WSPX</p><br>

      

      <span>

          <p class="intro">Las operaciones siguientes son compatibles. Para una definición formal, revise la <a href="WSPX.asmx?WSDL">descripción de servicios</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="WSPX.asmx?op=AutenticacionUsuarioPx">AutenticacionUsuarioPx</a>
                
                <span>
                  <br>Autenticación de usuario
                </span>
              </li>
              <p>
            
              <li>
                <a href="WSPX.asmx?op=ConsultaCarteraClientes">ConsultaCarteraClientes</a>
                
                <span>
                  <br>Retorna informacion la cartera de cliente por un vehículo específico
                </span>
              </li>
              <p>
            
              <li>
                <a href="WSPX.asmx?op=ConsultaComandos">ConsultaComandos</a>
                
                <span>
                  <br>Retorna informacion de comandos de bloqueo / desbloqueo en PX para un vehículo específico
                </span>
              </li>
              <p>
            
              <li>
                <a href="WSPX.asmx?op=ConsultaDispositivo">ConsultaDispositivo</a>
                
                <span>
                  <br>Retorna información de dispositivo en PX por vid
                </span>
              </li>
              <p>
            
              <li>
                <a href="WSPX.asmx?op=ConsultaOrden">ConsultaOrden</a>
                
                <span>
                  <br>Retorna información de Orden de Servicio en PX
                </span>
              </li>
              <p>
            
              <li>
                <a href="WSPX.asmx?op=ConsultaPropietario">ConsultaPropietario</a>
                
                <span>
                  <br>Retorna información de propietario en PX por identificador
                </span>
              </li>
              <p>
            
              <li>
                <a href="WSPX.asmx?op=ConsultaVehiculo">ConsultaVehiculo</a>
                
                <span>
                  <br>Retorna información de vehículo en PX por placa o código vehículo
                </span>
              </li>
              <p>
            
              <li>
                <a href="WSPX.asmx?op=EjecutaComandos">EjecutaComandos</a>
                
                <span>
                  <br>Ejecuta los comandos de bloqueo / desbloqueo en PX para un vehículo específico
                </span>
              </li>
              <p>
            
              <li>
                <a href="WSPX.asmx?op=InsertaOrden">InsertaOrden</a>
                
                <span>
                  <br>Registrar Orden de Servicio en PX
                </span>
              </li>
              <p>
