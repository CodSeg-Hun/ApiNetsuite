namespace ApiNetsuite.DTO.Bien
{
    public class GenVehiculo
    {
        ...
        public string IdTipoTerrestre { get; set; }
        ...
        public string IdColorCarseg { get; set; }

        public string ColorCarseg { get; set; }

        public string IdColorFabricante { get; set; }

        public string ColorFabricante { get; set; }

        public string IdColorMatricula { get; set; }

        public string ColorMatricula { get; set; }

        public string IdVersion { get; set; }

        public string Version { get; set; }

        public string IdTipoCabina { get; set; }

        public string TipoCabina { get; set; }

        public string IdCilindraje { get; set; }

        public string Cilindraje { get; set; }

        public string IdTraccion { get; set; }

        public string Traccion { get; set; }

        public string IdTipoFlota { get; set; }
        ...
        public string IdUsoVehicular { get; set; }

        public string UsoVehicular { get; set; }
        ...
        public string IdCopAsociacion { get; set; }

        public string CopAsociacion { get; set; }
        ...
        public string OSConvenio { get; set; }

        public string seguimiento { get; set; }

        public string CadenaCriterio { get; set; }
